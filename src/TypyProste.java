public class TypyProste {
    ...
    public static void main(String[] args) {
        ...
        long fourthNumber = 2148000L; //8 bajtów -2^63 do (2^63)-1 do 63 potęgi

        //liczby zmiennoprzecinkowe
        float fifthNumbar = 4.99934F; //4 bajty - max ok 6-7 liczb po przecinku
        double sixthNumber = 3.999999999999999D; //8 bajtów - max ok 15 cyfr po przecinku

        //wartośc logiczna, wartość true false
        boolean prawda = true;
        boolean falsz = false;
